...
/*DCT Functions*/
static int32_t butterfly_fw(int32_t Rs, uint8_t rotator);		                    // butterfly - Firmware implementation of the butterfly operation
...
static int32_t butterfly_fw(int32_t Rs, uint8_t rotator)
{
